...
export class Load extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image("exitButton", './images/red_button_300.png')
        this.load.image("skull", './images/512x512.png')

        // Cards
        this.load.image("1_or_11", './images/1_or_11.png');
        this.load.image("double", './images/double.png');
        this.load.image("redraw", './images/redraw.png');
        this.load.image("resurrect", './images/resurrect.png');
    ...
    create() {
        ...
        for (let i = 0; i < 10; i++) {
            const x = width * (0.05 + (i % 10 * 0.1));
            const y = height * (i < 10 ? 0.58 : 0.8);
            const blueFlame = this.add.sprite(x, y, 'blueFlame_spritesheet')
            blueFlame.setScale(3);
            blueFlame.play('blueFlame_spritesheet_ani');
        }
    }
